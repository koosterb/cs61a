...
def make_to_string(front, mid, back, empty_repr):
    ...
    def list_to_string(lst):
        if lst is Link.empty:
            ...
            return front + str(lst.first) + mid + list_to_string(lst.rest) + back
...
def add_trees(t1, t2):
    ...
    if length_t1 < length_t2:
        t1_branches += [0 for x in range(length_t2-length_t1)]
    elif length_t1 > length_t2:
        t2_branches += [0 for x in range(length_t1-length_t2)]
