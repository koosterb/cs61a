...
(define x (* (+ 1 3) (* 3 5 (+ 1 5 (/ 14 7)))))
; expect x

x
; expect 480

(define (swag-function x) 'swag)
; expect swag-function
...
(define x (begin (print 5) (swag-function 6)))
; expect x

x
; expect swag

(define swag2 (lambda (x y) (* x y (+ x y))))
; expect swag2

(swag2 1 2)
; expect 6

(and 1 2 3 5 (* 1 3 5 2 2 5 1 2) (/ 1 0))
; expect Error

(or 1 2 3 5 (* 1 3 5 2 2 5 1 2) (/ 1 0))
; expect 1
...
(factorial 200 30)
; expect 
