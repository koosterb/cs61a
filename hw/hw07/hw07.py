...
class Fib():
    ...
    def next(self):
        if self.value == 0:
            ...
            Fib.previous, self.value = self.value, self.value + Fib.previous
...
class VendingMachine:
    ...
    def restock(self, num):
        for _ in range(num):
            self.stock.append(self.item)
        return 'Current ' + self.item + ' stock: ' + str(len(self.stock))
...
class MissManners:
    ...
    def ask(self, message, *args):
        ...
        if hasattr(self.obj, request) is False:
